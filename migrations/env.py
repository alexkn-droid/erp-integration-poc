...
The database URL always comes from WebSettings (i.e. the same .env /
environment variables the app itself reads) — never hard-coded here and
never read from alembic.ini, so there is exactly one place DATABASE_URL
is configured.
"""
